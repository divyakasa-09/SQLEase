...
def load_user_query_history(user_name):
    ...
    query = f"SELECT * FROM dev_tools.SQLEase_user_query_history WHERE user_name = '{user_name}' AND timestamp > current_date - 20"
...
def add_to_user_history(user_name,question,query,favourite_ind):
    ...
    user_history_table = "hive_metastore.dev_tools.SQLEase_user_query_history"
